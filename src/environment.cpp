...
// Is FPS limited automatically (off by default while profiling so timings are visible)
bool project::fps_limiting = false;
// Maximal default FPS (used only of fps_max is true)
float project::fps_max=60.0f;
// Automatic synchronization of GLFW with the vertical-monitor refresh (off while profiling)
